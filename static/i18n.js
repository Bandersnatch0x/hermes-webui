...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    providers_official_title: 'Official Providers',
    providers_custom_title: 'Custom Providers',
    providers_create_btn: '+ Add Provider',
    providers_edit: 'Edit',
    providers_summary_active: 'Active provider',
    providers_summary_none: 'None',
    providers_summary_configured: 'Configured',
    providers_no_custom: 'No custom providers configured. Click "+ Add Provider" to create one.',
    providers_badge_configured: 'API configured',
    providers_badge_models_synced: 'models synced',
    providers_badge_active: 'active',
    providers_sync_retry: 'Retry sync',
    providers_custom_saved: 'Provider saved',
    provider_modal_create_title: 'Add Custom Provider',
    provider_modal_edit_title: 'Edit Provider',
    provider_modal_display_name: 'Display Name',
    provider_modal_adapter_type: 'Adapter Type',
    provider_modal_enabled: 'Enabled',
    provider_modal_base_url: 'Base URL',
    provider_modal_api_key: 'API Key',
    provider_modal_default_model: 'Default Model (optional)',
    provider_modal_response_format: 'Response Format',
    provider_modal_models_endpoint: 'Models Endpoint (optional)',
    provider_modal_usage_section: 'Usage Tracking (optional)',
    provider_modal_usage_strategy: 'Usage Strategy',
    provider_modal_usage_endpoint: 'Usage Endpoint URL',
    provider_modal_usage_parser: 'Parser Type',
    provider_modal_err_name: 'Display name is required',
    provider_modal_err_url: 'Base URL is required',
    ...
    profile_rename_label: 'New name (leave blank to keep)',
    profile_model_keep_current: 'Keep current',
    profile_api_key_placeholder_has: 'Leave blank to keep existing',
    profile_api_key_hint: 'Leave blank to keep existing key. Enter new value to overwrite.',
    profile_edit_name_readonly: 'Name cannot be changed for the default profile.',
    profile_updated: (name) => `Profile '${name}' updated`,
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    profile_edit_title: '编辑配置档',
    profile_rename_label: '新名称（留空保持不变）',
    profile_model_keep_current: '保持当前',
    profile_api_key_placeholder_has: '留空保持现有',
    profile_api_key_hint: '留空以保留现有密钥。输入新值以覆盖。',
    profile_edit_name_readonly: '默认配置档的名称不可更改。',
    profile_updated: (name) => `配置档 '${name}' 已更新`,
    update_failed: '更新失败',
